...
class connecting_sys_to_connect():
    def __init__(self, accessed_module, sys_to_connect, ctrl_root, side):
        print(f"CSTOC: MDL = {accessed_module}")
        print(f"CSTOC: sys_to_connect = {sys_to_connect}")
        self.mdl = accessed_module
    ...
    def create_nodes(self):
        ...
        self.MM_grp_node = f"MM_{self.mdl}{self.jnt_follow.replace('jnt_rig', '')}{self.side}"
